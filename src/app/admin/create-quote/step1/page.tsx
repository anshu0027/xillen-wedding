...
export default function QuoteGenerator() {
    ...
    const handleCalculateQuote = () => {
        if (validateForm()) {
            ...
            Object.entries(errors).forEach(([field, message]) => toast.error(message, { variant: 'custom', className: 'bg-white text-red-600' }));
    ...
    return (
        <>
            ...
            <div className="max-w-3xl w-full mx-auto px-4 sm:px-6 md:px-8 pb-16">
                <Card
                    title={
                        <span className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-900 drop-shadow">
                            Get Your Wedding Insurance Quote
                        </span>
                    }
                    subtitle={
                        <span className="text-base sm:text-lg md:text-xl text-blue-700 font-medium">
                ...
                >
                    <div className="space-y-10">
                        ...
                        <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-4 mt-8 flex items-start gap-3">
                            <AlertCircle size={20} className="text-yellow-500 mt-1 shrink-0" />
                            <div>
