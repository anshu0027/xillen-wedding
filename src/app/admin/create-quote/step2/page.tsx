...
export default function EventInformation() {
    ...
    return (
        <>
            ...
            <div className="w-full pb-12"> {/* Retain bottom padding, or manage spacing within sections */}
                {/* Honoree Information */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        ...
                        <div>
                            <h3 className="font-bold text-center text-gray-700 mb-4 text-lg">
                                Honoree #2 <span className="text-semibold text-sm text-gray-400">(if applicable)</span>
                            </h3>
                            <FormField
                                label={<span className="font-medium text-gray-800">First Name</span>}
