            ...
            <div className="w-full pb-12"> {/* Retain bottom padding if needed, or manage spacing within sections */}
                ...
                <div className="mb-10 shadow-2xl border-0 bg-white/90 p-8 sm:p-10 md:p-12 rounded-2xl w-full">
                    ...
                    <div className="space-y-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full"> {/* Matched gap from Admin Step3 */}
                            {/* First Name */}
                            <div className="mb-4">
                ...
                <div className="mb-8 shadow-lg border-0 bg-white p-8 sm:p-10 md:p-12 rounded-2xl w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full px-2 sm:px-4 md:px-8"> {/* Matched gap from Admin Step3 */}
                            {/* Phone Number */}
                            <div className="mb-4">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className={`appearance-none w-full text-center border rounded-md py-2 pl-3 pr-10 ${errors.state ? 'border-red-500' : 'border-gray-300'
                                            } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                                        required
                                    >
                ...
                {/* Navigation Buttons */}
                <div className="flex justify-between mt-10 gap-4 w-full"> {/* Added w-full to match Admin Step3 */}
                    <Button
                        variant="secondary"
                        onClick={handleBack}
