            ...
            <div className="w-full mx-auto mb-10 text-center shadow-2xl border-0 bg-white/90 rounded-2xl p-8 sm:p-10 md:p-12">
                ...
                <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-10">
                    ...
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="residentState" className="font-semibold text-gray-800">
                    ...
                    {/* Event Date */}
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="eventDate" className="font-semibold text-gray-800">Event Date</label>
                        <DatePicker
                    ...
                    {/* Email Address */}
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="email" className="font-semibold text-gray-800 block">Email Address</label>
                        <input
                            id="email"
                            type="email"
                            value={state.email || ''}
                    ...
                    {/* Coverage Level */}
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="coverageLevel" className="font-semibold text-gray-800">
                            Core Coverage Level
                        </label>
                        <div className="relative w-[325px]">
                            <select
                    ...
                    {/* Liability Coverage */}
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="liabilityCoverage" className="font-semibold text-gray-800">
                            Liability Coverage
                        </label>
                        <div className="relative w-[325px]">
                            <select
                    ...
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="liquorLiability" className="font-semibold text-gray-800">Host Liquor Liability</label>
                        <Checkbox
                            id="liquorLiability"
                            label={
                    ...
                    {/* Special Activities */}
                    <div className="mb-6 flex flex-col items-center">
                        <label htmlFor="specialActivities" className="font-semibold text-gray-800">Special Activities</label>
                        <Checkbox
