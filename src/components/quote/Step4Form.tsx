        ...
        <div className="space-y-8">
            ...
            <div className="w-full max-w-4xl mx-auto mb-6 border-gray-200 border rounded-2xl shadow-lg p-8 sm:p-10 md:p-12">
                ...
                <div className="flex items-center justify-center text-center mb-4 gap-4">
                    <div>
                        <div className="text-xl md:text-2xl font-extrabold leading-tight mb-1">Quote Summary</div>
                ...
                <div className="mt-8">
                    <div className="flex flex-col md:flex-row justify-end gap-4 w-full">
                        <Button
                            ...
                            size="lg"
                            onClick={onEmail}
                            className="w-full md:w-auto" // Use className for fullWidth or auto width
                        >
                            <Mail size={18} className="mr-2" /> {/* Icon as child */}
            ...
            <div className="flex flex-col md:flex-row justify-between gap-4 ml-10 w-full mt-4 px-5">
                <Button type="button" variant="outline" onClick={onBack} className="w-48 py-5">Back</Button>
            </div>
        </div>
    );
} 